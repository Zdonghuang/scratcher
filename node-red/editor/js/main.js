...
(function() {
        ...
        $.ajax({
            ...
            success: function(nodes) {
                if (nodes) {
                    ...
                    var workflow = sessionStorage.getItem('workflow-data');
                    if (workflow) { 
                        RED.nodes.import(JSON.parse(JSON.parse(workflow).content));
                    } else {
    ...
    function completeLoad() {
        ...
        $(window).on("message", function(e) {
            if (e.originalEvent.data == 'cmd-save') {
                RED.clipboard.export();
            }
        });        
    }
