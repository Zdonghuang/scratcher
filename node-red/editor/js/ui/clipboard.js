...
RED.clipboard = (function() {
    ...
    function importNodes() {
        ...
        // RED.nodes.import('[{"id":"f3730bec.bc34c8","type":"inject","z":"ecaee774.8bfb78","name":"","topic":"","payload":"888","payloadType":"str","repeat":"","crontab":"","once":false,"onceDelay":0.1,"x":130,"y":280,"wires":[["a8327325.e6fa"]]},{"id":"a8327325.e6fa","type":"debug","z":"ecaee774.8bfb78","name":"","active":true,"tosidebar":true,"console":false,"tostatus":false,"complete":"false","x":320,"y":300,"wires":[]}]',
        //     "full");
    ...
    function exportNodes() {
        ...
        var flow = JSON.stringify(nodes,null,4);

        sessionStorage.setItem('saved-workflow', flow);
        window.parent.postMessage('save-workflow');
        return;
